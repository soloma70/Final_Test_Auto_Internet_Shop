...
class RegSets:
    ...
    # При регистрации запрашивает код подтверждения по SMS - 6 цифр
    # Для успешной регистрации телефон д.б. реальным
    reg_phone = '505555555'
    # пароль должен быть не менее 6 символов, содержать цифры и заглавные буквы
    # Опытным путем установлено, что пароль должен содержать заглавную и матленькую латинские буквы
    reg_passw = 'vV123456'
