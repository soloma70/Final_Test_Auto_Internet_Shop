...
def test_registration_valid(web_driver_desktop):
    ...
    ВНИМАНИЕ!!! При повторном запуске теста регистрации необходимо поменять цифру в номере телефона
    в файле test_sets.py -> RegSets.reg_phone, т.к.при регистрации телефон попадает в базу системы"""
